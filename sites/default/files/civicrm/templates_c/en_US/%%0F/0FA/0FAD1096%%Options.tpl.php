<?php /* Smarty version 2.6.27, created on 2017-07-17 22:17:23
         compiled from CRM/Admin/Form/Options.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('block', 'crmScope', 'CRM/Admin/Form/Options.tpl', 1, false),array('block', 'ts', 'CRM/Admin/Form/Options.tpl', 32, false),)), $this); ?>
<?php $this->_tag_stack[] = array('crmScope', array('extensionKey' => "")); $_block_repeat=true;smarty_block_crmScope($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?><div class="crm-block crm-form-block crm-admin-options-form-block">
...
<br />
     ...
     <?php endif; ?>
      ...
      <?php if ($this->_tpl_vars['form']['value']['html'] && $this->_tpl_vars['gName'] != 'redaction_rule'): ?>
...
<br />
        ...
        <?php endif; ?>
        <?php if ($this->_tpl_vars['form']['grouping']['html']): ?>
          <tr class="crm-admin-options-form-block-grouping">
        ...
        <?php if ($this->_tpl_vars['form']['icon']['html']): ?>
        ...
        <?php endif; ?>
        <?php if ($this->_tpl_vars['form']['color']['html']): ?>
          <tr class="crm-admin-options-form-block-color">
            <td class="label"><?php echo $this->_tpl_vars['form']['color']['label']; ?>
</td>
            <td><?php echo $this->_tpl_vars['form']['color']['html']; ?>
</td>
          </tr>
        <?php endif; ?>
